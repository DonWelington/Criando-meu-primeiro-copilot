...
* Framework: Spring Boot 4.x (Módulos: Web, Security, etc.)
* Gerenciador de Build: (Maven / Gradle)
* Testes: (JUnit 5 + Mockito / AssertJ)
* Qualidade / Format: (Checkstyle / Spotless / ArchUnit)
* Banco de Dados & Persistência: (PostgreSQL + Spring Data JPA / Flyway)
* Infra: (Docker / K8s / AWS / GraalVM Native Image)
